...
This fork includes significant improvements over FossFlow:

- **UI/UX Redesign** - Completely redesigned and improved user interface and experience
- **Extended Localization** - Added support for 13 languages (EN, RU, DE, ES, FR, IT, PT, PL, TR, ZH, HI, BN, ID)
- **Theming** - Full light/dark theme support with system preference detection
- **Animations** - Smooth transitions and micro-interactions throughout the app
- **Storage Improvements** - Enhanced localStorage management with server-side storage option
- **Git Integration** - Auto-commit functionality for diagram changes
- **Performance** - Optimized rendering and reduced bundle size
- **MUI to Mantine** - Migrated from Material-UI to Mantine for better performance and flexibility
