...
export const arrowDirectionOptions = ['NONE', 'FORWARD', 'BACKWARD', 'BOTH'] as const;
...
export const connectorSchema = z.object({
  ...
  // Legacy arrow field (for backward compatibility)
  showArrow: z.boolean().optional(),
  // New arrow direction field (takes priority over showArrow)
  arrowDirection: z.enum(arrowDirectionOptions).optional(),
