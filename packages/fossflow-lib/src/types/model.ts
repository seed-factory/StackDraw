...
export { connectorStyleOptions, connectorLineTypeOptions, arrowDirectionOptions } from 'src/schemas';
...
export type ArrowDirection = (typeof arrowDirectionOptions)[number];
