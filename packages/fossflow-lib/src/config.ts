...
import { customVars } from './styles/mantineTheme';
...
export const VIEW_ITEM_DEFAULTS: Required<Omit<ViewItem, 'id' | 'tile' | 'layerId'>> = {
  labelHeight: 80
};
...
export const CONNECTOR_DEFAULTS: Required<Omit<Connector, 'id' | 'color' | 'layerId'>> = {
  ...
  style: 'SOLID',
  lineType: 'SINGLE',
  showArrow: true, // Legacy field for backward compatibility
